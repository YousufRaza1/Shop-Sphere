                      ...
                      children: [
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final review = viewModel.listOfReviews[
                                viewModel.listOfReviews.length - (index + 1)];
                            return Card(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          onPressed: () async {
                            viewModel.addToCartClicked(widget.product.id);
                          },
                        ...
                        ElevatedButton.icon(
                          onPressed: () {
                            Get.to(CheckoutScreen(
                                listOfProductId: [widget.product.id]));
                          },
